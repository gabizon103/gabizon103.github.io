+++
title = "Filament"
description = "Filament is a hardware description language that uses timing types to catch bugs."
+++

This post is a brief introduction to Filament, my main research project.
